...
public class RedBlackBSTQuestao5<Key extends Comparable<Key>, Value> {
    ...
    private Node ultimoNoAcessado; // Questão 4;
   ...
   // Questão 5
    private boolean isRed(Node x) {
       if (x.left.key.compareTo(x.right.key) > 0) { // Questão 5
           return true; // Questão 5
       }

       return false; // Questão 5
    }
    ...
    ***************************************************************************/
    ...
    public Value get(Key key) {
        ...
        if (key.compareTo(ultimoNoAcessado.key) == 0) { // Questão 4
    ...
    ***************************************************************************/
    ...
    private Node put(Node h, Key key, Value val) {
        if (h == null) {
            Node novoNo = new Node(key, val, RED, 1); // Questão 4
            ultimoNoAcessado = novoNo; // Questão 4
            return novoNo; // Questão 4
        }
